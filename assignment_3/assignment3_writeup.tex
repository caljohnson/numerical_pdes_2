...
Table 2 shows the difference in the sums between the initial condition and the final solution $u(x,y,1)$.
\begin{table}[H]
\caption{Peaceman-Rachford ADI Scheme - Energy Conservation}
